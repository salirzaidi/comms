...
![ScreenshotofIDE](./assets/SC1 (ttn webpage).jpg)
...
Click **Login with The Things ID**. After loggin in, click on console from the user drop down menu on the right ![ScreenshotofIDE](./assets/SC2 (ttn console).jpg)
